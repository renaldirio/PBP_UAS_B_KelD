        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.input_nama_user),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText.perform(replaceText("rio"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.input_alamat_user),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText2.perform(replaceText("jogja"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText3 = onView(
                allOf(withId(R.id.input_email_user),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText3.perform(replaceText("rio@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText5 = onView(
                allOf(withId(R.id.input_nomortelp_user),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText5.perform(replaceText("0987654321"), closeSoftKeyboard());
